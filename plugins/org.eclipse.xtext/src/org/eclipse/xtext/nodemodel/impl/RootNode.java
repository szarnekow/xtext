...
public class RootNode extends CompositeNodeWithSemanticElementAndSyntaxError {
	...
	/**
	 * Returns an array that contains the offsets of each line break in the input. Note that the result is not a copy
	 * but the actually internal data structure of this node.
	 * 
	 * @return an array of offsets of each line break in the input or <code>null</code> if the {@link #completeContent}
	 *         has not been set.
	 * @since 2.0
	 */
	 ...
	 * <code>\r\n</code>, <code>\n</code>, or a single <code>\r</code>.
	 * </p>
	 * This implementation was heavily adapted from <code>org.eclipse.jface.text.DefaultLineTracker</code>.
	 * 
	 * @param text
	 *            the text whose line-breaks should be computed. May not be <code>null</code>.
